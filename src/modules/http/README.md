...
Реализован базовый функционал для создания **HTTP**-клиента или **HTTP**-сервера. Модуль разбит на три подмодуля по схеме `*-common / *-server / *-client` (см. общий обзор архитектуры в `CLAUDE.md`).
