...
- Процесс **Request/Response** **NestJS Kafka** подразумевает, что полученный ответ на отправленный запрос будет вычитан консъюмером того же **Pod**-а, что осуществимо только при использовании динамических групп и является очень плохим практическим решением.
